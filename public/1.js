...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    totalPrice: function totalPrice() {
      console.log(this.$store.state.cart.reduce(function (acc, current) {
    ...
    submit: function submit() {
      ...
      var msg = this.$store.state.cart;
      console.log(msg);
      this.$http.post('https://api.telegram.org/bot${this.token}/sendMessage?chat_id=${this.chatId}&text=${msg}').then(function (response) {
        console.log("Success");
      }, function (error) {
        console.log("fail ");
