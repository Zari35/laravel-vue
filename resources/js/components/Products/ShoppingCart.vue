        ...
        <div class="flex shadow-md">
            ...
            <div id="summary" class="w-1/4 px-8 py-10">
                ...
                <div class="border-t mt-8">
                    ...
                    <button type="submit" class="bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Passer à la caisse</button>
                </div>
...
<script>
    export default {
        data(){
            return{ 
//BOT config
            token:"2015851930:AAFQoBT7asYPDe7DqX3CY6R4ZFuUUZnsRfg",
             chatId:-727154869,
            }
        },
        computed: {
            ...
            totalPrice() {
                console.log(this.$store.state.cart.reduce((acc, current) => acc + current.price * current.qty, 0))
           ...
           // methods:{ 
             submit(){
                ...
                // return $this.getCart.product.name;
               // const msg = 'hi this is token '+this.token
                const msg = this.$store.state.cart
                console.log(msg);
               ...
               //  return this.$http.post('https://api.telegram.org/bot2015851930:AAFQoBT7asYPDe7DqX3CY6R4ZFuUUZnsRfg/sendMessage?chat_id=-727154869&text=You have 3 data in the table')
